...
<head>
  ...
  <title>Logística ${escapeHtml(eventInfo.title)}</title>
  <meta name="description" content="Seguimiento de objetivos del área de Logística del ${escapeHtml(eventInfo.title)}." />
...
<body>
  <header class="hero">
    ...
    <div class="wrap hero-content">
      <button type="button" class="theme-toggle" id="themeToggle" aria-label="Cambiar tema claro/oscuro">🌓</button>
